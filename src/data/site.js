...
export const footerColumns = [
  ...
  {
    title: 'Layanan',
    links: ['Survei & Pemetaan', 'Inspeksi Infrastruktur', 'Pertanian Presisi', 'Inspeksi Termal', 'Sewa Harian & Bulanan'],
    href: '#layanan',
  },
  {
    title: 'Perusahaan',
    links: ['Tentang AERONUSA', 'Cara Sewa', 'Hasil Data', 'Kontak', 'Karier Pilot'],
    href: '#kontak',
  },
]
